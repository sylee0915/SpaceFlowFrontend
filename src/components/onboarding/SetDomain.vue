...
.name-input { width: 100%; background-color: rgba(255, 255, 255, 0.3); border: 2px solid #1A1A1A; padding: 24px; border-radius: 20px; font-size: 17px; text-align: center; outline: none; }
</style>